...
const Preview: React.FC = () => {
    ...
    return (
        <div className="bg-white dark:bg-neutral-900 text-neutral-900 dark:text-neutral-100 rounded-md border border-neutral-200 dark:border-neutral-700 shadow-md p-6 text-sm">
            ...
            <table className="w-full text-sm border border-neutral-200 dark:border-neutral-700 mb-4">
                <thead>
                    <tr className="bg-neutral-100 dark:bg-neutral-800 text-left">
                        ...
                        <th className="p-2 font-semibold border border-neutral-200 dark:border-neutral-700">Qty</th>
                        <th className="p-2 font-semibold border border-neutral-200 dark:border-neutral-700">Price</th>
                        <th className="p-2 font-semibold border border-neutral-200 dark:border-neutral-700">Total</th>
                    </tr>
                </thead>
                <tbody>
                    {items.map((item, idx) => (
                        <tr key={idx} className={idx % 2 === 0 ? 'bg-white dark:bg-neutral-900' : 'bg-neutral-50 dark:bg-neutral-800'}>
                            ...
                            <td className="p-2 border border-neutral-200 dark:border-neutral-700">{item.quantity}</td>
                            <td className="p-2 border border-neutral-200 dark:border-neutral-700">{formatCurrency(item.price)}</td>
            ...
            <div className="flex justify-end mb-4">
                <div className="grid grid-cols-2 gap-x-4 text-right text-sm min-w-[200px]">
            ...
            <div>
                ...
                <p className="text-sm text-neutral-600 dark:text-neutral-400">{notes || 'Thank you for your business!'}</p>
            </div>
        </div>
    );
};
