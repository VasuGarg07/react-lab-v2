...
interface EntityCardProps {
    ...
    onClick: () => void;
    onDelete: () => void;
    // Drag-and-drop props (from useSortable)
...
export default function EntityCard({
    ...
    return (
        <div
            ...
            `}
        >
            {/* Drag Handle - only shown when dragHandleProps provided */}
            {dragHandleProps && (
                <div
                    {...dragHandleProps}
            ...
            <div className="flex items-center gap-1 shrink-0">
                <button
                    ...
                    className="p-1.5 rounded-md text-neutral-400 hover:text-red-500 hover:bg-red-50 dark:hover:bg-red-900/20 opacity-0 group-hover:opacity-100 transition-all duration-200"
                    title="Delete"
                >
