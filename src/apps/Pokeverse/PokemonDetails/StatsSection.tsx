...
export default function StatsSection({ pokemon }: StatsSectionProps) {
                    ...
                    <div className="grid grid-cols-3 gap-2 mt-4">
                        {pokemon.stats.map((stat) => {
                            ...
                            return (
                                <div
                                    key={stat.name}
                                    className="text-center p-2 bg-neutral-50 dark:bg-neutral-700 rounded-lg"
                                >
                        ...
                        return (
                            ...
                            >
                                ...
                                <div className="relative w-full h-2 bg-neutral-200 dark:bg-neutral-700 rounded-full overflow-hidden">
                                    <div
                                        className={`absolute top-0 left-0 h-full rounded-full transition-all duration-500 ${getStatColor(
                                            stat.value
                                        )}`}
