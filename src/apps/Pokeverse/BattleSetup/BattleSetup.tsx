...
export default function BattleSetup() {
    ...
    const selectAllRegions = () => {
        setSelectedRegionsLocal(REGIONS.map(r => r.name.toLowerCase()));
    };

    const clearAllRegions = () => {
        setSelectedRegionsLocal([]);
    };
                                ...
                                return (
                                    ...
                                    >
                                        ...
                                        <div className="relative flex flex-col items-center gap-2">
                                            <div className={`p-2 rounded-full transition-colors ${isSelected
                                                ? 'bg-yellow-500'
                                                : 'bg-neutral-200 dark:bg-neutral-700 group-hover:bg-yellow-400'
                                                }`}>
                                    ...
                                    >
                                        ...
                                        <div className="relative">
                                            ...
                                            <p className="text-xs text-neutral-500 dark:text-neutral-400 mt-0.5">
                                                Gen {region.generation} • {region.endId - region.startId + 1} Pokémon
                                            </p>
                                        </div>
                                    </button>
                                );
