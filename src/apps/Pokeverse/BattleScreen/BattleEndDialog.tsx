        ...
        <div className="py-2">
            <div className="flex flex-col md:flex-row">
                ...
                <div className="md:w-1/2 p-8 flex flex-col justify-center items-center">
                    ...
                    <button
                        onClick={onPlayAgain}
                        className="flex items-center gap-2 px-6 py-3 bg-linear-to-r from-blue-600 to-blue-700 hover:from-blue-700 hover:to-blue-800 dark:from-blue-700 dark:to-blue-800 dark:hover:from-blue-800 dark:hover:to-blue-900 text-white font-bold rounded-lg shadow-lg hover:shadow-xl transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-blue-500/50 focus:ring-offset-2 hover:scale-105"
                    >
                        <RotateCcw size={20} />
