...
import { Banknote, CircleGauge, Cog, Gem, Landmark, LayoutList, Moon, PiggyBank, ShoppingCart, Sun } from 'lucide-react';
...
const NavLinks: Omit<LinkBtnProps, 'isMobile'>[] = [
    ...
    { path: 'incomes', label: 'Incomes', icon: <PiggyBank size={20} /> },
    { path: 'expenses', label: 'Expenses', icon: <ShoppingCart size={20} /> },
    { path: 'investments', label: 'Investments', icon: <Landmark size={20} /> },
