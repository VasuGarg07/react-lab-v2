        ...
        <div className="max-w-xl mx-auto space-y-8">
            <header className="space-y-1 pt-2">
                <Link
                    ...
                    className="inline-flex items-center gap-1 text-sm text-stone-400 dark:text-stone-500 hover:text-stone-700 dark:hover:text-stone-300 transition-colors mb-3"
                >
                    <ChevronLeft className="w-4 h-4" />
                    Back to library
                </Link>
                <h1 className="font-serif text-3xl text-stone-900 dark:text-stone-100">
                    {isEditMode ? 'Edit notebook' : 'New notebook'}
                </h1>
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
                ...
                <div className="flex items-center justify-end gap-3 pt-4 border-t border-stone-200 dark:border-stone-700">
                    <Link
                        to={BLOGIFY_ROUTES.LIBRARY}
                        className="px-4 py-2.5 text-sm font-medium rounded-xl text-stone-500 dark:text-stone-400 hover:text-stone-800 dark:hover:text-stone-200 hover:bg-stone-100 dark:hover:bg-stone-800 transition-colors"
                    >
                        Cancel
                    </Link>
