...
export default function TeamSelection() {
    ...
    return (
        <div className="min-h-screen bg-linear-to-br from-blue-50 via-neutral-50 to-purple-100 dark:from-neutral-900 dark:via-blue-950 dark:to-purple-950 py-8 px-4">
            <div className="max-w-7xl mx-auto">
                <div className="text-center mb-8">
                    ...
                    <p className="text-neutral-600 dark:text-neutral-300 font-medium">Select your squad and reveal your champions! ✨</p>
                </div>
                ...
                <div className="grid lg:grid-cols-2 gap-8">
                    ...
                    <div className="space-y-4">
                        <div className="flex items-center justify-between">
                            <h2 className="text-xl font-bold text-blue-600 dark:text-blue-400">{players[0].name}</h2>
                            {!revealedP1 && selectedP1Team !== null && (
                                <button onClick={handleConfirmP1} className="px-4 py-2 bg-blue-600 hover:bg-blue-700 text-white rounded-lg text-sm font-semibold transition-all duration-200 shadow-md hover:shadow-lg">
                                    Reveal Team
                                </button>
                            )}
                            {revealedP1 && (
                                <span className="px-3 py-1 bg-green-100 dark:bg-green-900/30 text-green-700 dark:text-green-400 rounded-full text-sm font-semibold">✓ Confirmed</span>
                            )}
                        </div>
                    ...
                    <div className="space-y-4">
                        <div className="flex items-center justify-between">
                            <h2 className="text-xl font-bold text-red-600 dark:text-red-400">{players[1].name}</h2>
                            {!revealedP2 && selectedP2Team !== null && (
                                <button onClick={handleConfirmP2} className="px-4 py-2 bg-red-600 hover:bg-red-700 text-white rounded-lg text-sm font-semibold transition-all duration-200 shadow-md hover:shadow-lg">
                                    Reveal Team
                                </button>
                            )}
                            {revealedP2 && (
