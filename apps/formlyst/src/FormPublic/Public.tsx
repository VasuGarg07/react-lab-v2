...
export default function Public() {
    ...
    const handleNext = () => {
        if (validateStep()) {
            ...
            if (isLastStep) navigate(`/formlyst/fill/${shareUrl}/review`);
        ...
        return (
            <div className="min-h-screen flex items-center justify-center bg-neutral-50 dark:bg-neutral-900 px-4">
                <div className="text-center max-w-sm">
                    ...
                    <h1 className="text-xl font-semibold text-neutral-900 dark:text-neutral-100 mb-2">Form Unavailable</h1>
                    <p className="text-sm text-neutral-500 dark:text-neutral-400">This form is no longer accepting responses or doesn't exist.</p>
                </div>
            </div>
        );
    }
        ...
        <div className="min-h-screen bg-neutral-50 dark:bg-neutral-900 px-4 py-8">
            <div className="max-w-xl mx-auto">
                <div className="text-center mb-4">
                    <h1 className="text-2xl font-bold text-neutral-900 dark:text-neutral-100 mb-1">{formConfig.title}</h1>
                    {formConfig.description && <p className="text-sm text-neutral-500 dark:text-neutral-400">{formConfig.description}</p>}
                </div>
