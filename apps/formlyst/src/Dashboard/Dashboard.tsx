...
export default function Dashboard() {
    ...
    const handleCreate = (template: FormTemplate) => {
        createForm.mutate(template.config, {
            onSuccess: (form) => { modal.close(); navigate(`/formlyst/${form.id}/edit`); },
        });
    };
    ...
    const openTemplateDialog = () => {
        modal.open(<TemplateDialog onCreate={handleCreate} isLoading={createForm.isPending} />);
    };
    ...
    if (error) {
        return (
            <div className="flex flex-col items-center justify-center min-h-[60vh] text-center px-4">
                <p className="text-neutral-600 dark:text-neutral-400 mb-3">Unable to load forms</p>
                <button onClick={() => window.location.reload()} className="text-sm text-blue-600 dark:text-blue-400 hover:underline">
                    Try again
                </button>
            </div>
        );
    ...
    return (
        <div className="max-w-6xl mx-auto px-4 py-8">
            <div className="flex items-center justify-between mb-8">
                <div>
                    <h1 className="text-xl font-semibold text-neutral-900 dark:text-neutral-100">FormLyst</h1>
            ...
            {forms && forms.length > 0 ? (
                ...
                <div className="flex flex-col items-center justify-center py-20 text-center">
                    ...
                    <h2 className="text-lg font-medium text-neutral-900 dark:text-neutral-100 mb-1">No forms yet</h2>
