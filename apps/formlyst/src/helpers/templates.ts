...
export const TEMPLATES: FormTemplate[] = [
    {
        ...
        config: { title: 'New Form', description: '', steps: [] },
    },
    {
        id: 'contact',
        name: 'Contact Form',
        ...
        config: {
            ...
            steps: [{
                key: 'contact_info', title: 'Contact Information', description: '',
                sections: [{
                    key: 'details', title: 'Your Details', description: '',
                    fields: [
    ...
    },
    {
        ...
        config: {
            ...
            steps: [
                {
                    key: 'rating', title: 'Your Rating', description: '',
                    sections: [{
                        key: 'experience', title: 'Rate Your Experience', description: '',
                        fields: [
                ...
                {
                    key: 'comments', title: 'Additional Comments', description: '',
                    sections: [{
                        key: 'feedback', title: 'Your Feedback', description: '',
                        fields: [
    ...
    },
    {
        ...
        config: {
            ...
            steps: [
                {
                    key: 'attendee', title: 'Attendee Information', description: '',
                    sections: [{
                        key: 'personal', title: 'Personal Details', description: '',
                        fields: [
                            { key: 'name', label: 'Full Name', type: 'text', required: true },
                ...
                {
                    key: 'preferences', title: 'Preferences', description: '',
                    sections: [{
                        key: 'options', title: 'Event Options', description: '',
                        fields: [
    ...
    },
    {
        ...
        config: {
            ...
            steps: [
                {
                    key: 'personal', title: 'Personal Information', description: '',
                    sections: [{
                        key: 'basic', title: 'Basic Information', description: '',
                        fields: [
                            { key: 'name', label: 'Full Name', type: 'text', required: true },
                            { key: 'email', label: 'Email', type: 'text', required: true },
                ...
                {
                    key: 'experience', title: 'Experience', description: '',
                    sections: [{
                        key: 'work', title: 'Work Experience', description: '',
                        fields: [
                ...
                {
                    key: 'additional', title: 'Additional Information', description: '',
                    sections: [{
                        key: 'other', title: 'Other Details', description: '',
                        fields: [
