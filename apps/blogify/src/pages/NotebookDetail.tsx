    ...
    if (!notebook) {
        return (
            <div className="flex flex-col items-center justify-center min-h-100 text-center">
                <p className="font-serif text-xl text-stone-800 mb-2">Notebook not found</p>
    ...
    return (
        <div className="max-w-3xl mx-auto space-y-8">
            ...
            <header className="space-y-6">
                <div className="aspect-21/9 w-full rounded-2xl overflow-hidden bg-stone-200">
                ...
                <div className="flex items-start justify-between gap-4">
                    <div className="space-y-3 flex-1 min-w-0">
                        <div className="flex items-center gap-2.5">
                            <h1 className="font-serif text-3xl text-stone-900 leading-tight">{notebook.title}</h1>
                        ...
                        {notebook.description && (
                            <p className="text-stone-500 leading-relaxed">{notebook.description}</p>
                        )}
                        ...
                        <Link to={BLOGIFY_ROUTES.NOTEBOOK_AUTHOR(notebook.author)} className="inline-flex items-center gap-2.5 hover:opacity-75 transition-opacity">
                            ...
                            <span className="text-sm font-medium text-stone-700">{notebook.author}</span>
                    ...
                    {isOwner && (
                        <div className="flex items-center gap-2 shrink-0">
                            <Link
                                ...
                                className="inline-flex items-center gap-1.5 px-3 py-2 rounded-xl bg-stone-900 text-stone-50 text-xs font-medium hover:bg-stone-700 transition-colors"
                            >
            ...
            <section className="space-y-4 pt-6 border-t border-stone-100">
                <div className="flex items-baseline gap-2">
                    <h2 className="font-serif text-xl text-stone-900">Blogs</h2>
                    <span className="text-sm text-stone-400">{blogCount}</span>
                </div>
                <BlogGallery
                    blogs={blogs}
