...
export default function BlogForm({
    notebooks, defaultValues, isEditMode = false, isLoading = false, onSubmit, onSaveDraft,
}: BlogFormProps) {
    ...
    return (
        <form onSubmit={handleSubmit(handleFormSubmit)} className="space-y-7">
            ...
            <Controller
                ...
                render={({ field }) => (
                    <TextInput {...field} label="Title" placeholder="Enter an engaging title..." error={errors.title?.message} />
                )}
            />
            ...
            <div className="space-y-2">
                ...
                />
                {errors.blogContent && <p className="text-xs text-red-500">{errors.blogContent.message}</p>}
            </div>
            ...
            <div className="flex items-center justify-end gap-3 pt-4 border-t border-stone-100 dark:border-stone-800">
                ...
                <LoadingButton type="submit" isLoading={isLoading} disabled={isLoading || !notebookId}>
