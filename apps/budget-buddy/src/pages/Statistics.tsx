                    ...
                    <ResponsiveContainer width="100%" height={240}>
                        <LineChart data={timelineData} margin={{ top: 8, right: 16, left: 0, bottom: 0 }}>
                            ...
                            <XAxis
                                ...
                                tick={{ fontSize: 11, fill: 'currentColor' }} className="text-neutral-400 dark:text-neutral-500"
                            ...
                            <Line
                                type="monotone" dataKey="Balance" stroke={TYPE_COLORS.income} strokeWidth={2}
