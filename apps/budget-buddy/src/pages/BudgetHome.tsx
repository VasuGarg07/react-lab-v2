    ...
    return (
        <div className="space-y-6">
            ...
            <div className="grid grid-cols-2 lg:grid-cols-4 gap-3">
                <BalanceCard label="Income" amount={totalIncome} variant="income" barPct={100} />
                <BalanceCard label="Expenses" amount={totalExpense} variant="expense" barPct={totalIncome > 0 ? (totalExpense / totalIncome) * 100 : 0} />
                <BalanceCard label="Balance" amount={balance} variant="neutral" barPct={totalIncome > 0 ? (balance / totalIncome) * 100 : 0} />
                <BalanceCard label="Savings Rate" amount={savingsRate} variant="neutral" suffix="%" barPct={savingsRate} />
            </div>
                                    ...
                                    return (
                                        <div key={category}>
                                            <div className="flex items-center gap-2.5 mb-1.5">
                                                ...
                                                <span className="text-xs text-neutral-600 dark:text-neutral-400 flex-1 truncate">{category}</span>
                                            ...
                                            <div className="h-0.5 bg-neutral-100 dark:bg-neutral-700 ml-9">
                                                <div className="h-0.5 bg-red-400 dark:bg-red-500 transition-all duration-500" style={{ width: `${pct}%` }} />
                                            </div>
                                        </div>
                                    );
                                })}
